    ...
    return (
        <section className="relative py-14">
            <div className="relative z-10 max-w-screen-xl">
                <div className="">
                    <ul className="grid items-center gap-x-6 sm:grid-cols-2 lg:grid-cols-3 ">
                        {
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl border shadow-md w-[400px]">
                                    <div className="p-4 ">
                                    ...
                                    <figure className=''>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-indigo-50">
                                            <Image alt="Alumni" height={100} width={100} src={item.avatar} className="w-16 h-16 rounded-full border-2 border-Es_primary" />
                                            <div>
                                                <span className="block text-gray-800 font-semibold">{item.name}</span>
                                                <span className="block text-Es_primary text-sm mt-0.5">{item.title}</span>
                                            </div>
                                        </div>
                                    </figure>
                                </li>
